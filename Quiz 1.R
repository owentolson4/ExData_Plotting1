setwd("C:/Users/Owen.Tolson/Desktop/R Practice/Exploratory Data Analysis/Week 1")
...
ggsave("Plot1.png", height = 12.7, width = 12.7, units = "cm")
...
ggsave("Plot2.png", height = 12.7, width = 12.7, units = "cm")
...
ggsave("Plot3.png", height = 12.7, width = 12.7, units = "cm")
